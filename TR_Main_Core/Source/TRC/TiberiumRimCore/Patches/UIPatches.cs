    ...
    public static class Dialog_OptionsDoUIOptions_Patch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            for (var i = 0; i < instructionList.Count; i++)
            {
                ...
                {
                    if(previous.opcode == OpCodes.Call && previous.Calls(_WindowStackGetter) && cur.opcode == OpCodes.Ldloc_S && (cur.operand as LocalBuilder).LocalIndex.Equals(25))
                    {
                ...
                if(cur.opcode == OpCodes.Stloc_S && (cur.operand as LocalBuilder).LocalIndex.Equals(24))
                {
                    yield return cur;
