...
namespace TR
{
    ...
    public class RepairDrone : MechanicalPawn, IPawnWithParent
    {
        ...
        public bool OutsideOfStationRadius => HasNoStation || parentComp.parent.Position.DistanceTo(this.Position) > parentComp.Props.radius;
        public bool HasNoStation => parentComp == null;
