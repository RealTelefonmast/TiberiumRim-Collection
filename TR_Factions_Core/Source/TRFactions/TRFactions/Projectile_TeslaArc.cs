...
public class Projectile_TeslaArc : Projectile
{
    ...
    public override void Impact(Thing hitThing, bool blockedByShield = false)
    {
        ...
        DamageInfo dinfo = new DamageInfo(this.def.projectile.damageDef, (float)base.DamageAmount * DamageMultiplier,
            base.ArmorPenetration, this.ExactRotation.eulerAngles.y, this.launcher, null, this.equipmentDef,
        ...
        if (hitThing is Pawn || (hitThing.Stuff != null && hitThing.Stuff.IsMetal))
        {
            ...
            foreach (var thing in options)
            {
                ...
                Projectile_TeslaArc newArc =
                    (Projectile_TeslaArc)GenSpawn.Spawn(this.def, hitThing.Position, hitThing.Map);
